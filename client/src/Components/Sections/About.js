        ...
        <div className='about'>
            <div className='about-container'>
                <div className='about-info-card'>
                    ...
                    <p>I am a self taught software developer. Digging into my new passion, I focused on learning the basics of HTML, CSS, and JavaScript before putting it all together by learning React.<br /><br />
                        ...
                        When I am not working on my latest projects, I can be found at various pick up basketball locations around San Diego, hanging at the beach, or playing chess!</p>
                </div>
